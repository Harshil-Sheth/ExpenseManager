...
const AddDeleteTransaction = (): any => {
    ...
    return (
      ...
      <form>
        <div className="form-control">
          ...
          <input type="text" value={text} onChange={(e: any): any=>setText(e.target.value)} placeholder="Enter text..." />
        </div>
        <div className="form-control">
          ...
          >
          <input type="number"  value={amount} onChange={(e: any): any=>setAmount(e.target.value)} placeholder="Enter amount..." />
        </div>
